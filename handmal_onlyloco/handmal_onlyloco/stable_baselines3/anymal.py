...
from handmal_onlyloco.env.bin import rsg_anymal
from handmal_onlyloco.stable_baselines3.RaisimSbGymVecEnv import RaisimSbGymVecEnv as VecEnv
...
task_path = stb_path + "/../env/envs/handmal_onlyloco"
