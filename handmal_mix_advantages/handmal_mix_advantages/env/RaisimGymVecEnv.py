...
class RaisimGymVecEnv:
    ...
    def __init__(self, impl, normalize_ob=True, seed=0, clip_obs=10.):
        ...
        self._arm_reward = np.zeros(self.num_envs, dtype=np.float32)
    ...
    def step(self, action):
        self.wrapper.step(action, self._reward, self._arm_reward, self._done)
        return self._reward.copy(), self._arm_reward.copy(), self._done.copy()
