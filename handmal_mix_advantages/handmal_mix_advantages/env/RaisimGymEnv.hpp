...
class RaisimGymEnv {
 ...
 public:
  ...
  virtual Eigen::Vector2f step(const Eigen::Ref<EigenVec>& action) = 0;
  virtual bool isTerminalState(float& terminalReward, float& arm_terminalReward) = 0;
  ////////////////////////////////////////
  ...
  raisim::Reward& getarmRewards() { return arm_rewards_; }
 protected:
