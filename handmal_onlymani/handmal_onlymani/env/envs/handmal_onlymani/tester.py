...
from handmal_onlymani.env.bin import handmal_onlymani
...
env = VecEnv(handmal_onlymani.RaisimGymEnv(home_path + "/rsc", dump(cfg['environment'], Dumper=RoundTripDumper)), cfg['environment'])
...
if weight_path == "":
    ...
    for step in range(max_steps):
        ...
        torque_values.append(torque.copy())
