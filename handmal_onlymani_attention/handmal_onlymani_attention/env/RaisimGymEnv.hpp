...
class RaisimGymEnv {
 ...
 public:
  ...
  virtual float step(const Eigen::Ref<EigenVec>& action, const Eigen::Ref<EigenVec>& attention) = 0;
  ...
  virtual void getTorque(Eigen::Ref<EigenVec> torque) {};
  virtual void setCommand(Eigen::Ref<EigenVec>& command) {};
  ////////////////////////////////
