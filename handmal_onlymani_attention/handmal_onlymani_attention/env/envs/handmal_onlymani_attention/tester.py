...
from handmal_onlyma.env.bin import handmal_onlyma
from handmal_onlyma.env.RaisimGymVecEnv import RaisimGymVecEnv as VecEnv
import handmal_onlyma.algo.ppo.module as ppo_module
import os
import math
import time
import torch
...
env = VecEnv(handmal_onlyma.RaisimGymEnv(home_path + "/rsc", dump(cfg['environment'], Dumper=RoundTripDumper)), cfg['environment'])
