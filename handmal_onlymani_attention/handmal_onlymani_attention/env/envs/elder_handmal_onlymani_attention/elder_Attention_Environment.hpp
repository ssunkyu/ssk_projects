...
//            gc_init_ << 0, 0, 0.54, 1.0, 0.0, 0.0, 0.0, 0.03, 0.4, -0.8, -0.03, 0.4, -0.8, 0.03, -0.4, 0.8, -0.03, -0.4, 0.8, 0.0, -2.6, -1.57, 0.0, 2.0, 0.0;
            ...
            handmal_->setMass(handmal_->getBodyIdx("kinova_link_1"),0.1 * handmal_->getMass(handmal_->getBodyIdx("kinova_link_1")));
            handmal_->setMass(handmal_->getBodyIdx("kinova_link_2"),0.1 * handmal_->getMass(handmal_->getBodyIdx("kinova_link_2")));
            handmal_->setMass(handmal_->getBodyIdx("kinova_link_3"),0.1 * handmal_->getMass(handmal_->getBodyIdx("kinova_link_3")));
